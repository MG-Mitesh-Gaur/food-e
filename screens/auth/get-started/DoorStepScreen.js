...
const DoorStepScreen = () => {
  ...
  return (
	...
	<ImageBackground source={images.doorstep_screen} className="w-full h-full">
		<SafeAreaView style={SafeViewAndroid.AndroidSafeArea} className="flex-1 justify-between">
			...
			<View className="mx-4 mb-12">
				<View className="mb-12">
					<Text className="uppercase text-4xl w-12/12 font-bold" style={{color: colors.white}}>DELIVERED AT YOUR <Text style={{color: colors.primary}}>DOORSTEP</Text></Text>
        ...
        <CustomButton title={'next'} importStyle={{
					marginBottom: 0
				}} primary tapHandler={()=> {navigation.navigate(navigations.GrabDeals)}} />
			</View>
		</SafeAreaView>
	</ImageBackground>
	</>
